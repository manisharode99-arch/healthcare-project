...
GCS_BUCKET = "dev_healthcarebuck1"
...
BQ_PROJECT = "halogen-plasma-479315-c8"
...
# MySQL Configuration
MYSQL_CONFIG = {
   "url": "jdbc:mysql://34.57.201.220:3306/healthcare?useSSL=false&allowPublicKeyRetrieval=true",
...
for row in config_df.collect():
    ...
    if str(is_active) == '1' and database == "healthcare":
